...
work_dirs = "work_dirs/ara/r101_tusimple"
...
optimizer = dict(type='AdamW', lr=0.3e-3)  
    ...
    dict(
        ...
        transforms=[
            ...
            dict(name='MultiplyAndAddToBrightness',
                 parameters=dict(mul=(0.85, 1.15), add=(-10, 10)), p=0.6),
...
dataset = dict(
    train=dict(type=dataset_type, data_root=dataset_path, split='trainval', processes=train_process),
